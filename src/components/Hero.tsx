      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-border bg-secondary/50 px-4 py-2 text-sm text-muted-foreground"
          >
          ...
          >
            ...
            <div className="flex items-center gap-8 opacity-50">
              ...
              <div className="hidden text-lg font-semibold text-foreground sm:block">CloudBase</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
